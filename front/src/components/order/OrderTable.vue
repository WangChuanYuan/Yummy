  ...
  <el-table :data="orders" stripe>
        ...
        <div class="clear-fix">
          <div style="float: left">
            <img
              ...
              style="height: 60px; width: 60px; border-radius: 60px; cursor: pointer"
              @click="$router.push(`/bookCenter/${scope.row.rid}`)"/>
          </div>
          <div class="omission" style="padding-left: 5px; color: var(--theme-medium-grey)">
    ...
    <el-table-column label="操作" width="150">
      <template slot-scope="scope">
        ...
        <div v-else-if="scope.row.status === 'PAYED'">
